...
function customSet(arr) {
  ...
  let custSet = new Set(arr);
  for (const item of custSet) {
...
function setToArray(mySet) {
  ...
  let arr = [...mySet];
  return arr.filter((element) => typeof element === "string").sort();
}
...
function iterateSet(set) {
  ...
  for (const itrKey of setKeys) {
    console.log(itrKey);
  }
  let setValues = set.values();
  for (const itrValue of setValues) {
